...
class ListCameras final :
    public ::PROTOBUF_NAMESPACE_ID::internal::ZeroFieldsBase /* @@protoc_insertion_point(class_definition:indiemotion.protobuf.payloads.v1.ListCameras) */ {
 public:
...
class MotionXForm final :
 ...
 public:
  ...
  PROTOBUF_NODISCARD ::indiemotion::protobuf::payloads::v1::XFormData* release_translation();
  ...
  PROTOBUF_NODISCARD ::indiemotion::protobuf::payloads::v1::XFormData* release_orientation();
